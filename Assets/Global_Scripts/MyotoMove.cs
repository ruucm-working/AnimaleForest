...
public class MyotoMove : MonoBehaviour
{
    ...
    void Update ()
    {
        ...
        if (thalmicMyo.pose == Pose.Fist){
           Debug.Log("Press Fire(CONTROL) Key");
       ...
       if(myo.transform.forward.y <  -0.5){
    ...
    if(myo.transform.forward.x >  0.5){
    ...
    if(myo.transform.forward.z >  0.5){
